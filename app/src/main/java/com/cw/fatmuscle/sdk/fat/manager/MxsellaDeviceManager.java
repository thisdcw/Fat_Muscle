...
import com.cw.fatmuscle.sdk.fat.entity.FlashMsg;
import com.cw.fatmuscle.sdk.fat.entity.ResultMsg;
import com.cw.fatmuscle.sdk.fat.entity.VersionMsg;
import com.cw.fatmuscle.sdk.fat.inter.DataTransListerner;
import com.cw.fatmuscle.sdk.fat.interfaces.DeviceResultInterface;
    ...
    public void eventDevice(DeviceMsg deviceMsg) {
        ...
        if (msgId == -1) {
            ...
            for (Object obj2 : this.interfaceHashMap.keySet()) {
                if (this.interfaceHashMap.get(obj2) instanceof com.cw.fatmuscle.sdk.manager.MxsellaDeviceManager.DeviceResultInterface.DeviceCommonInterface) {
                    Log.i(TAG, "remove");
