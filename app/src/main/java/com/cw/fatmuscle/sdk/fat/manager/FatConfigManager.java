...
import com.cw.fatmuscle.sdk.fat.entity.ApiMemberInfo;
import com.cw.fatmuscle.sdk.fat.entity.BodyParts;
import com.cw.fatmuscle.sdk.fat.entity.ConfigParameter;
import com.cw.fatmuscle.sdk.fat.entity.DeviceDefaultParams;
...
//                    bodyParts.setGuideVideo(Integer.valueOf(R.raw.yaobu_guide));
...
//                    }
//                    bodyParts.setGuideVideo(Integer.valueOf(R.raw.arm_guide));
...
//                    bodyParts.setGuideVideo(Integer.valueOf(R.raw.datui_guide));
//                    bodyParts.setGuideTip(Integer.valueOf(R.string.yao_guide));
...
//                    bodyParts.setGuideVideo(Integer.valueOf(R.raw.xiaotui_guide));
//                    bodyParts.setGuideTip(Integer.valueOf(R.string.yao_guide));
...
//                    bodyParts.setGuideVideo(Integer.valueOf(R.raw.fb_guide));
//                    bodyParts.setGuideTip(Integer.valueOf(R.string.yao_guide));
...
//            }
    ...
    public void init(Context context) {
        ...
        this.isAutoMeasure = Config.getBoolean(this.mContext, MxsellaConstant.AUTO_MEASURE_MODE, false);
        this.isFangkeMode = Config.getBoolean(this.mContext, MxsellaConstant.FANGKE_MODE, false);
        this.fangkeSex = Config.getInt(this.mContext, MxsellaConstant.FANGKE_SEX, 1);
        this.measureMode = Config.getInt(this.mContext, MxsellaConstant.MEASURE_MODE, this.measureMode);
        this.defaultRssiValue = Config.getInt(this.mContext, MxsellaConstant.RSSI_FILTER, this.defaultRssiValue);
        initConfigParameter();
    }
