package com.cw.fatmuscle.view.dialog;
    ...
    public static class Builder {
        ...
        public CustomDialog create() {
            ...
            if (this.isVerticalScreen) {
                ...
                inflate = layoutInflater.inflate(R.layout.app_dialog_custom, (ViewGroup) null);
            }
            ...
            if (this.leftButtonText != null) {
                ...
                if (this.leftButtonClickListener != null) {
                    // from class: com.marvoto.fat.dialog.CustomDialog.Builder.2
// android.view.View.OnClickListener
            ...
            if (this.singleButtonText != null) {
                ...
                if (this.singleButtonClickListener != null) {
                    // from class: com.marvoto.fat.dialog.CustomDialog.Builder.3
// android.view.View.OnClickListener
