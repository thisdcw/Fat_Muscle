...
import com.mxsella.fatmuscle.comm.Protocol;
...
import com.mxsella.fatmuscle.comm.interfaces.IDataTransfer;
...
//                    UsbDevice usbDevice = MainActivity.usbDevice;
                    if (intent.getBooleanExtra(UsbManager.EXTRA_PERMISSION_GRANTED, false)) {
                        LogUtil.i("-> 1111");
                        if (usbDevice.getVendorId() == Protocol.VENDOR_ID && usbDevice.getProductId() == Protocol.PRODUCT_Id) {
                            LogUtil.i("-> 1112");
