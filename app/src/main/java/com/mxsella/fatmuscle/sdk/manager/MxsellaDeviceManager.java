...
import com.mxsella.fatmuscle.sdk.fat.entity.DeviceInfo;
import com.mxsella.fatmuscle.sdk.fat.entity.DeviceTcpMsg;
import com.mxsella.fatmuscle.sdk.fat.entity.DeviceUdpMsg;
import com.mxsella.fatmuscle.sdk.service.DaemonThreads;
import com.mxsella.fatmuscle.sdk.service.DeviceImageDataTcpService;
import com.mxsella.fatmuscle.sdk.service.DeviceUdpSerialDataService;
...
public class MxsellaDeviceManager {
    ...
    public void receiveByteData(byte[] bArr) {
        LogUtil.d("receiver -> " + Arrays.toString(bArr));
